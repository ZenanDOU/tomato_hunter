...
The system SHALL provide a unified「狩猟看板」component that replaces the separate Inbox and HuntList tabs. The hunt board SHALL display tasks in collapsible sections grouped by status.
