  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {inboxTasks.length === 0 && !showForm && (
        <p className="text-stone-500 text-sm">{NARRATIVE.inboxEmpty}</p>
      )}
...
function InboxItem({
  ...
  return (
    <div className="bg-white p-3 outline-2 outline-[#333333] outline-offset-[-2px] shadow-[2px_2px_0_0_rgba(0,0,0,0.25)] flex justify-between items-center">
      <div>
        <div className="font-bold text-sm text-[#333333]">{task.name}</div>
